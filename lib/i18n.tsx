...
const dict: Record<string, { en: string; lg: string; sw: string; luo: string }> = {
  ...
  'prof.item.lcLetter':     { en: 'LC1 / area letter',       lg: 'Ettendekero lya LC1',   sw: 'Barua ya LC1 / mtaa',   luo: 'Calo me LC1' },
  ...
  'prof.certPhotoLabel':  { en: 'Photo of certificate (optional)', lg: 'Ekifaananyi kya satifikeeti (si kya ddembe)', sw: 'Picha ya cheti (si lazima)', luo: 'Kite me satifiket (pe teko)' },
  'prof.lcTitle':         { en: 'LC1 / area letter (optional)', lg: 'Ettendekero lya LC1 (si lya ddembe)', sw: 'Barua ya LC1 (si lazima)', luo: 'Calo me LC1 (pe teko)' },
  'prof.lcSub':           { en: 'A letter from your LC1 or area leader — raises your profile strength and speeds up vetting.', lg: 'Ettendekero okuva ku LC1 wo — lyongera amaanyi ga profile yo era espeeda vetting.', sw: 'Barua kutoka kwa LC1 au kiongozi wa mtaa — huinua wasifu wako na kuharakisha uhakiki.', luo: 'Calo ki bot LC1 onyo lalo — teko profile mera ka dwiro vetting.' },
