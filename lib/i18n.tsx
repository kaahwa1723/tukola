...
const dict: Record<string, { en: string; lg: string; sw: string; luo: string }> = {
  ...
  'ie.howCustomer':     { en: 'Invite a household — they get UGX {amount} off their first job, and you get UGX {amount} credit when it completes. Credit is spent inside Tukola only — never cash.', lg: 'Yita amaka — bafuna UGX {amount} off ku mulimu gwabwe ogusoose, nawe ofuna UGX {amount} credit bwe gujjukira. Credit ekozzebwa mu Tukola yokka.', sw: 'Mwalike familia — watapata UGX {amount} off kazi yao ya kwanza, nawe utapata UGX {amount} credit ikikamilika. Credit inatumika ndani ya Tukola tu.', luo: 'Lwong gang — ginongo UGX {amount} off i ticgi me munyu, ka otum inongo UGX {amount} kredit. Kredit tiyo i Tukola keken.' },
  'ie.howFundi':        { en: 'Invite a fundi — when they complete their first paid job, you get UGX {a} credit and they get UGX {b}. Credit is spent inside Tukola only — never cash.', lg: 'Yita fundi — omulimu gwe ogusoose ogusasulwa bwe gujjukira, ofuna UGX {a} credit era naye afuna UGX {b}. Credit ekozzebwa mu Tukola yokka.', sw: 'Mwalike fundi — kazi yake ya kwanza ya kulipwa ikikamilika, unapata UGX {a} credit na yeye anapata UGX {b}. Credit inatumika ndani ya Tukola tu.', luo: 'Lwong fundi — ticge me munyu ma giculo ka otum, inongo UGX {a} kredit en onongo UGX {b}. Kredit tiyo i Tukola keken.' },
  ...
  // ── Trust-layer profile gate (24 Sep 2026) ─────────────
  // AI-drafted non-English — native review pending (project rule).
  'prof.requiredTitle': { en: 'Required to apply for jobs',  lg: 'Ebyetaagisa okusaba emirimu', sw: 'Inahitajika kuomba kazi', luo: 'Ma mite me penyo tic' },
  'prof.boostTitle':    { en: 'Boosts your profile',         lg: 'Biyambako profile yo',  sw: 'Huinua wasifu wako',    luo: 'Giteko profile mera' },
  'prof.gateBanner':    { en: 'Complete these items — employers choose complete profiles first.', lg: 'Jjuza bino — abakugu balonda profile ezijjuziddwa okusooka.', sw: 'Kamilisha hivi — waajiri huchagua wasifu kamili kwanza.', luo: 'Pong’ magi — jo ma miyo tic yero profile ma opong’ mokuongo.' },
  'prof.item.phone':        { en: 'Phone number (login)',    lg: 'Namba ya fone (okuyingira)', sw: 'Namba ya simu (kuingia)', luo: 'Namba me cim (donyo iyie)' },
  'prof.item.avatar':       { en: 'Profile photo',           lg: 'Ekifaananyi kya profile', sw: 'Picha ya wasifu',       luo: 'Kite me profile' },
  'prof.item.location':     { en: 'Your area',               lg: 'Ekifo kyo',             sw: 'Eneo lako',             luo: 'Kabedo mera' },
  'prof.item.about':        { en: 'About you',               lg: 'Ebikukwatako',          sw: 'Kuhusu wewe',           luo: 'Gin maku kwedi' },
  'prof.item.skills':       { en: 'Skills',                  lg: 'Ebyokusobola',          sw: 'Ujuzi',                 luo: 'Gin ma itiyo' },
  'prof.item.momo':         { en: 'Mobile Money payout number', lg: 'Namba ya Mobile Money', sw: 'Namba ya Mobile Money', luo: 'Namba me Mobile Money' },
  'prof.item.nationalId':   { en: 'National ID (number + photo)', lg: 'National ID (namba + kifaananyi)', sw: 'Kitambulisho cha taifa (namba + picha)', luo: 'Kadi me lanyut (namba + kite)' },
  'prof.item.nextOfKin':    { en: 'Next of kin (name + phone)', lg: 'Omulamu w’okufuna (linnya + namba)', sw: 'Ndugu wa karibu (jina + simu)', luo: 'Dano ma cok (nying + namba)' },
  'prof.item.sexDob':       { en: 'Sex & date of birth',     lg: 'Ekkikula n’ennaku y’okuzalibwa', sw: 'Jinsia & tarehe ya kuzaliwa', luo: 'Co/dako & nino ceng' },
  'prof.item.qualification': { en: 'Trade qualification / certificate', lg: 'Ebyokusomera / satifikeeti', sw: 'Sifa / cheti cha ufundi', luo: 'Loc / satifiket me tic' },
  'prof.item.lcOrCert':     { en: 'LC1 / area letter or certificate', lg: 'Ettendekero lya LC1 oba satifikeeti', sw: 'Barua ya LC1 au cheti', luo: 'Calo me LC1 onyo satifiket' },
  'prof.item.portfolio':    { en: 'Work portfolio photos',   lg: 'Ebifaananyi by’emirimu gyo', sw: 'Picha za kazi zako',   luo: 'Kite me tic mera' },
  'prof.idTitle':         { en: 'National ID',               lg: 'National ID',           sw: 'Kitambulisho cha taifa', luo: 'Kadi me lanyut' },
  'prof.idSub':           { en: 'Your NIN and a photo of the card — our vetting team reviews it for your ID-verified badge. Only you and the vetting team see this.', lg: 'NIN yo n’ekifaananyi kya kaadi — ttiimu y’okukakasa ekikituula ku badge yo ya ID-verified. Ggwe n’ekimu kyokka abalabe.', sw: 'NIN yako na picha ya kadi — timu yetu ya uhakiki haiiangalii kwa badge yako ya ID-verified. Wewe na timu tu mnaona.', luo: 'NIN mera ki kite me kadi — tim me vetting nono ne pi badge mera me ID-verified. Iwu ki tim mera keken ma neno.' },
  'prof.idPh':            { en: 'NIN e.g. CM1234567890AB',   lg: 'NIN nga: CM1234567890AB', sw: 'NIN mf. CM1234567890AB', luo: 'NIN cal: CM1234567890AB' },
  'prof.idPhotoLabel':    { en: 'Photo of your ID card',     lg: 'Ekifaananyi kya kaadi yo', sw: 'Picha ya kadi yako',   luo: 'Kite me kadi mera' },
  'prof.nokTitle':        { en: 'Next of kin',               lg: 'Omulamu w’okufuna',     sw: 'Ndugu wa karibu',       luo: 'Dano ma cok' },
  'prof.nokSub':          { en: 'Who we contact in an emergency — part of your verified profile.', lg: 'Ani gwetukwasagana nga waliwo ekibuzo — kitundu kya profile yo ekakasiddwa.', sw: 'Tunayemwasiliana naye dharura ikitokea — sehemu ya wasifu wako uliothibitishwa.', luo: 'Ngat ma wakwongo ka gino otime — piek profile mera ma oyee.' },
  'prof.nokNamePh':       { en: 'Full name',                 lg: 'Erinnya lyonna',        sw: 'Jina kamili',           luo: 'Nyinge dutu' },
  'prof.nokPhonePh':      { en: 'Phone e.g. 0772 123 456',   lg: 'Namba nga: 0772 123 456', sw: 'Simu mf. 0772 123 456', luo: 'Namba cal: 0772 123 456' },
  'prof.qualTitle':       { en: 'Qualification (optional)',  lg: 'Ebyokusomera (si bya ddembe)', sw: 'Sifa (si lazima)',   luo: 'Loc (pe teko)' },
  'prof.qualSub':         { en: 'e.g. DIT, UVTAB or UBTEB certificate — raises your profile strength and speeds up vetting.', lg: 'Nga satifikeeti ya DIT, UVTAB oba UBTEB — yongera amaanyi ga profile yo era espeeda vetting.', sw: 'Mf. cheti cha DIT, UVTAB au UBTEB — huinua wasifu wako na kuharakisha uhakiki.', luo: 'Cal: satifiket me DIT, UVTAB onyo UBTEB — teko profile mera ka dwiro vetting.' },
  'prof.qualPh':          { en: 'e.g. DIT Certificate in Plumbing', lg: 'Nga: DIT Certificate in Plumbing', sw: 'Mf. DIT Certificate in Plumbing', luo: 'Cal: DIT Certificate in Plumbing' },
  'prof.certPhotoLabel':  { en: 'Photo of certificate (counts as LC proof)', lg: 'Ekifaananyi kya satifikeeti (kikola nga LC)', sw: 'Picha ya cheti (inahesabiwa kama LC)', luo: 'Kite me satifiket (kwan ne calo me LC)' },
  'prof.lcTitle':         { en: 'LC1 / area letter',         lg: 'Ettendekero lya LC1',   sw: 'Barua ya LC1 / mtaa',   luo: 'Calo me LC1' },
  'prof.lcSub':           { en: 'A letter from your LC1 or area leader — key evidence for your ID-verified badge. A certificate photo above also counts.', lg: 'Ettendekero okuva ku LC1 wo — ekkubo ery’okukakasa badge yo. Ekifaananyi kya satifikeeti waggulu nakyo kikola.', sw: 'Barua kutoka kwa LC1 au kiongozi wa mtaa — ushahidi muhimu kwa badge yako. Picha ya cheti hapo juu pia inahesabiwa.', luo: 'Calo ki bot LC1 onyo lalo — lok ma madit pi badge mera. Kite me satifiket malo bene kwan ne.' },
  'prof.photoUploaded':   { en: 'Photo added',               lg: 'Ekifaananyi kya wansi', sw: 'Picha imeongezwa',      luo: 'Kite kimedo' },
  'prof.uploading':       { en: 'Uploading…',                lg: 'Ekiroloada…',           sw: 'Inapakia…',             luo: 'Ka medo…' },
