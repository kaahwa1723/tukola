...
const dict: Record<string, { en: string; lg: string; sw: string; luo: string }> = {
  ...
  'prof.gateBanner':    { en: 'Complete the required items to apply for jobs.', lg: 'Jjuza ebyetaagisa osobe okusaba emirimu.', sw: 'Kamilisha vipengele vinavyohitajika ili kuomba kazi.', luo: 'Pong’ gin ma mite wek ibed me penyo tic.' },
  ...
  'prof.idSub':           { en: 'Your NIN and a photo of the card — required before you can take jobs. Only you and our vetting team see this.', lg: 'NIN yo n’ekifaananyi kya kaadi — kyetaagisa nga tonnafuna mirimu. Ggwe n’ekimu kyokka abalabe.', sw: 'NIN yako na picha ya kadi — inahitajika kabla ya kupata kazi. Wewe na timu yetu tu mnaona.', luo: 'NIN mera ki kite me kadi — mite ka pud pe inongo tic. Iwu ki tim mera keken ma neno.' },
  ...
  'prof.nokSub':          { en: 'Who we contact in an emergency — required before you can take jobs.', lg: 'Ani gwetukwasagana nga waliwo ekibuzo — kyetaagisa nga tonnafuna mirimu.', sw: 'Tunayemwasiliana naye dharura ikitokea — inahitajika kabla ya kupata kazi.', luo: 'Ngat ma wakwongo ka gino otime — mite ka pud pe inongo tic.' },
  ...
  'prof.lcSub':           { en: 'A letter from your LC1 or area leader — required before you can take jobs. A certificate photo above also counts.', lg: 'Ettendekero okuva ku LC1 wo — lyetaagisa nga tonnafuna mirimu. Ekifaananyi kya satifikeeti waggulu nakyo kikola.', sw: 'Barua kutoka kwa LC1 au kiongozi wa mtaa — inahitajika kabla ya kupata kazi. Picha ya cheti hapo juu pia inahesabiwa.', luo: 'Calo ki bot LC1 onyo lalo — mite ka pud pe inongo tic. Kite me satifiket malo bene kwan ne.' },
